...
<head>
    ...
    <title>Paw Haven - Add New Accessory</title>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Add New Accessory</h2>
                    ...
                    <form action="{{ route('admin.accessories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" required
                                        ...
                                        <option value="Leash" {{ old('category') == 'Leash' ? 'selected' : '' }}>Leash</option>
                                        <option value="Bowl" {{ old('category') == 'Bowl' ? 'selected' : '' }}>Bowl</option>
                                        <option value="Toy" {{ old('category') == 'Toy' ? 'selected' : '' }}>Toy</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="stock" id="stock" value="{{ old('stock') }}" min="1" required
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    @error('stock')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    ...
                                    <select name="color" id="color" required
                                        ...
                                        @php
                                            $colors = [
                                                ...
                                                'Brown', 'Orange', 'Purple', 'Pink', 'Gray', 'Cyan',
                                                'Magenta', 'Maroon', 'Teal', 'Beige', 'Lime', 'Navy'
                                            ];
                                        @endphp
                        ...
                        <div>
                            ...
                            <select name="main_image" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                @for ($i = 1; $i <= 5; $i++)
                                    <option value="{{ $i }}" {{ old('main_image') == $i ? 'selected' : '' }}>Image {{ $i }}</option>
                                @endfor
                            </select>
                            @error('main_image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
